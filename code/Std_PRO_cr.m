...
[d_cr(2), v_cr(2), t_cr(2), a_cr(2)] = Std_AA_cr(d, v, a, comm(3), j_max);
...
[d_cr(3), v_cr(3), t_cr(3), a_cr(3)] = Std_CA_cr(d_cr(2), comm(2), v_cr(2), comm(3), j_max);

% DA step
[d_cr(4), v_cr(4), t_cr(4), a_cr(4)] = Std_CA_cr(d_cr(3), comm(2), v_cr(3), comm(3), j_max);
